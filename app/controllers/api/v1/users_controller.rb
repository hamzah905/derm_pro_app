class Api::V1::UsersController < Api::V1::BaseController
  ...
  private
    ...
    def patient_obj(user)
      ...
      user.attributes.merge(full_name: user.first_name + " " + user.last_name, avatar: user.avatar.url, query_spots: query_spots.collect{|query_spot| query_spot.query_spot_obj }).except("first_name", "last_name")
    end
